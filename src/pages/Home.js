...
const Home = () => {
  return (
    <main>
      ...
      <div className="container mx-auto p-4 absolute z-10 -bottom-56">
        <form className="block rounded-lg">
          <div className="flex items-center justify-center  ">
            ...
            <div className="flex items-center justify-center absolute right-96">
              <img className="h-20" src="https://hotel.bdtask-demo.com/xainhotel/website_assets/img/small-vertical.svg" alt="" />
              <div className="bg-red-700 text-slate-300 p-1 text-sm rounded">
