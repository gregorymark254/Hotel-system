      ...
      <div className="container mx-auto p-3">
        <nav className='flex justify-between items-center w-full '>
          ...
          <section className="hidden md:flex divide-x-2 ">
            ...
            <ul className="bg-red-700 text-white">
              <li>
                <Link to="/rooms" className="hover:text-slate-300 px-3 py-2 md:flex items-center "><FaRegCalendarAlt/> &nbsp; Book Now</Link>
              </li>
            </ul>
          </section>
          ...
          {navIsShown && (
            <div className='md:hidden absolute z-10 top-0 left-0 w-full bg-gray-100/90 text-black px-4 py-6'>
              <div className='flex justify-between border-b-2 border-b-gray-600'>
                <div className="flex items-center ">
                  <img src="https://hotel.bdtask-demo.com/xainhotel/assets/img/2021-11-18/h.png" alt="" />
                </div>
                <svg
              ...
              <ul className=' mb-4'>
                <li>
                  <a href="/" className="hover:text-red-500 px-3 py-2 text-lg">Home</a>
                </li>
                <li>
                  <a href="/about" className="hover:text-red-500 px-3 py-2 text-lg">About</a>
                </li>
                <li>
                  <a href="/contact" className="hover:text-red-500 px-3 py-2 text-lg">Contact Us</a>
                </li>
                <li>
              ...
              <div className="flex">
                ...
                <ul className="bg-red-700 text-white">
                  <li>
                    <a href="/rooms" className="hover:text-slate-300 px-3 py-2 flex items-center "><FaRegCalendarAlt/> &nbsp; Book Now</a>
                  </li>
                </ul>
              </div>
            </div>
